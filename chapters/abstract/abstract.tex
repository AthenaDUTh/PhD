...
Third, a high-throughput experimentation approach is introduced to investigate the ambient phase stability of \ch{CsPbI_2Br} thin films and overcome challenges related to extreme batch-to-batch or even within-batch variations. Through the deposition of a broad compositional gradient across a 6'' wafer, it is derived that an excess of CsBr within strict limits during the co-evaporation of CsBr and \ch{PbI_2} precursors is necessary to boost the films' ambient stability from a few hours to several months. 
