...
\begin{figure}[ht!]
    ...
    \begin{subfigure}[t]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{chapters/transport_layers/images/EDS_TEM_TiO2.pdf} % Replace with your image file
        \caption{}
        \label{}
    \end{subfigure}
    \hspace{0.5cm}
 ...
 % Second row
    \begin{subfigure}[t]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{chapters/transport_layers/images/SEM_TiO2.pdf} % Replace with your image file
        \caption{}
        \label{}
    \end{subfigure}
    \hspace{0.5cm}
...
\begin{figure}[ht!]
    ...
    \begin{subfigure}[t]{0.45\textwidth} % Adjust width as needed
        \centering
        \includegraphics[width=\textwidth]{chapters/transport_layers/images/Thickness_Effect.pdf} % Replace with your image
        \caption{}
        \label{}
    \end{subfigure}
    ...
    \begin{subfigure}[t]{0.45\textwidth} % Adjust width as needed
        \centering
        \includegraphics[width=\textwidth]{chapters/transport_layers/images/Annealing_Effect.pdf} % Replace with your image
        \caption{}
        \label{}
    \end{subfigure}
    % Caption for the whole figure
    \caption[Impact of grain size and \ch{C_{60} thickness on the current density variability.}]{(a) Impact of \ch{C_{60}} thickness and (b) perovskite annealing conditions on the PePDs' median current density and interquartile range in dark conditions.}
...
\begin{figure}[htbp]
    ...
    \caption[Current density as a function of time for sample 20\ch{TiO_2}-20\ch{C_{60}} under prolonged (1 hr) biasing at -2 V.]{Current density as a function of time for sample 20\ch{TiO_2}-20\ch{C_{60}} under prolonged (1 hr) biasing at -2 V. No sings of breakdown are observed with the specific stack configuration. Reproduced from \cite{Papadopoulou2025ElectronSpeed}.}
...
\begin{figure}[htbp]
    ...
    \end{subfigure}
    \caption[Optical constants of all PePD layers used for the optical simulation of the 40\ch{TiO_2} sample.]{Optical constants of all PePD layers used for the optical simulation of the 40\ch{TiO_2} sample. Reproduced from \cite{Papadopoulou2025ElectronSpeed}.}
...
\begin{figure}[htbp]
    ...
    \caption[Frequency-dependent capacitance for samples with various combinations of the \ch{C_{60}}-\ch{TiO_2} bi-layer configuration.]{Frequency-dependent capacitance for samples (a) 40\ch{TiO_2}, (b) 40\ch{C_{60}}, and (c) 20\ch{C_{60}}-20\ch{TiO_2}, biased at 0 V and -2 V. The collapse of the capacitance for sample 40\ch{TiO_2} at -2 V and frequencies below 10 Hz is another aftermath of the breakdown mechanism that is triggered under the effect of prolonged reverse bias. Reproduced from \cite{Papadopoulou2025ElectronSpeed}.}
