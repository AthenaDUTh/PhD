\documentclass[final, faculty=fiiw,department=elt,phddegree=elt]{adsphd}
...
%%% COVER: Settings %%%
\title{Vacuum Deposited, All-Inorganic Perovskite Photodiodes}
%\subtitle{Multiscale computing for Dummies}

\author{Athina}{Papadopoulou}
\president{Prof.~dr.~ir.~Raf Dewil}{}
\supervisor{Prof.~dr.~ir.~Jan Genoe}{}
\supervisor{Prof.~dr.~ir.~Paul Leroux}{}
\jurymember{Prof.~dr.~Pol Van Dorpe}{KU Leuven}
\jurymember{Prof.~dr.~Johan Hofkens}{KU Leuven}
\jurymember{Prof.~dr.~Maarten B. J. Roeffaers}{KU Leuven}
\externaljurymember{Prof.~dr.~ir.~Rene A.J. Janssen}{TU Eindhoven}
\externaljurymember{Dr.~ir.~Sofie Put}{Mirion Technologies}

% Your research group within the department
% e.g. iMinds-DistriNet, Scientific Computing Group, ...
\researchgroup{}
\website{} % Leave empty to hide
\email{athina.papadopoulou@imec.be} % Leave empty to hide
...
\includechapter{material_properties}
\includechapter{ellipsometry}
\includechapter{transport_layers}
\includechapter{stability}
